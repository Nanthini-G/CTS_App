...
def register():
    ...
    cursor.execute("""
        INSERT INTO users (Name, Email, Phone, Address, DOB, BloodGroup, BMI, Age, Gender)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    """, (data['Name'], data['Email'], data['Phone'], data['Address'], data['DOB'],
          data['BloodGroup'], data['BMI'], data['Age'], data['Gender']))
